...
public enum ErrorCode {
    ...
    SOCIAL_CREDENTIALS_REQUIRED(HttpStatus.BAD_REQUEST, 1603, "SOCIAL/BUSINESS 카테고리는 계정 정보(credentials)가 필수입니다."),
    ...
    INVALID_FIELD_FOR_SOCIAL(HttpStatus.BAD_REQUEST, 1616, "SOCIAL/BUSINESS 카테고리에서는 playlist 필드를 사용할 수 없습니다."),
